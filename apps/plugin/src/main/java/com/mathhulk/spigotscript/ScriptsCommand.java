...
public class ScriptsCommand implements CommandExecutor, TabCompleter {
    private final SpigotScript spigotScript;

    public ScriptsCommand(SpigotScript spigotScript) {
        this.spigotScript = spigotScript;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments) {
        ...
        if (firstArgument.equals("stop-watching")) {
            ScriptManager scriptManager = spigotScript.getScriptManager();
        ...
        if (firstArgument.equals("list")) {
            ArrayList<Script> scripts = spigotScript.getScriptManager().getScripts();
        ...
        if (firstArgument.equals("enable")) {
            ...
            Script script = spigotScript.getScriptManager().getScript(scriptName);
        ...
        if (firstArgument.equals("remove")) {
            ...
            spigotScript.getScriptManager().removeScript(scriptName);
        ...
        if (firstArgument.equals("add")) {
            ...
            Script existingScript = spigotScript.getScriptManager().getScript(scriptName);
            ...
            Script script = spigotScript.getScriptManager().addScript(scriptName, true);
